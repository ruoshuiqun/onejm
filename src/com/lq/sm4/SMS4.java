...
public class SMS4 {
    ...
    public static final byte[] KEY = { -31, -112, -112, 121, 110, -39, -31, 11, -32, -128, 72, 31, 89, -34, -89, 12 };
     // 基本密码部件,S盒置换,非线性变换τ,L变换,T变换
   ...
   public static byte[] encodeSMS4(String plaintext, byte[] key) {
     ...
     */
    public static String decodeSMS4toString(byte[] ciphertext, byte[] key,String enCoding) throws UnsupportedEncodingException {
     ...
     * @return
     */
    static byte[] encode16(byte[] plaintext, byte[] key) {
     ...
     * @return
     */
    static byte[] decode16(byte[] ciphertext, byte[] key) {
